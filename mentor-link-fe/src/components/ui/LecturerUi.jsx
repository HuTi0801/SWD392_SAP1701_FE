...
export const Sidebar = () => {
    ...
    return (
        <div className="w-1/7 bg-white p-4 text-white space-y-8">
            ...
            <SidebarButton icon={<GroupIcon />} label="Chat" onClick={() => navigate('/home-lecturer')} />
            <SidebarButton icon={<CalendarMonthIcon />} label="Report" onClick={() => navigate('/home-lecturer')} />
        </div>
    );
};
